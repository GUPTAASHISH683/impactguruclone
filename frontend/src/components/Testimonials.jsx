...
export default function Testimonials() {
  ...
  const [sectionData,  setSectionData]  = useState({ heading: 'What Our Donors & Campaigners Say', subheading: 'Rated 4.8/5 by over 48,000 users' })
    ...
    <section id="testimonials" aria-labelledby="testimonials-heading" className="py-20 bg-hero-gradient" ref={ref}>
      <div className="max-w-7xl mx-auto px-6">
        <header className="text-center mb-14 reveal">
          <span className="inline-block bg-orange-500/10 border border-orange-400/30 text-orange-300 text-xs font-semibold uppercase tracking-widest px-4 py-1.5 rounded-full mb-3" aria-hidden="true">Real Stories</span>
